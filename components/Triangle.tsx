...
export default function Triangle({variant, side, ...props}: TriangleProps) {
  if (variant === 'top') {
    if (side === 'left') {
      return (
        <svg className="fill-[url(#gradient)] h-[10rem] 2xl:h-[15rem] scale-101" viewBox="0 0 100 64" preserveAspectRatio="none" {...props}>
  ...
  if (side === 'left') {
    return (
      <svg className="fill-[url(#gradient)] h-[10rem] 2xl:h-[15rem] scale-101" viewBox="0 0 100 64" preserveAspectRatio="none">
